...
SET time_zone = "+00:00";
SET FOREIGN_KEY_CHECKS = 0; -- Tắt kiểm tra khóa ngoại để tránh lỗi khi tạo

-- 1. Bảng USERS (Gốc của mọi liên kết)
...
-- 6. Cấu trúc câu hỏi QUIZ (Questions -> Options)
...
-- 7. Lịch sử làm bài (Attempts -> Answers)
...
-- 8. Theo dõi học tập (Enrollments & Progress)
...
CREATE TABLE IF NOT EXISTS quiz_tag_relations (
  quiz_id INT NOT NULL,
  tag_id INT NOT NULL,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
