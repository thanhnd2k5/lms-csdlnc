# Phần Ứng dụng. Minh họa giao diện hệ thống

## 9.1. Mục đích minh họa giao diện
...
![Hình 9.8. Cấu trúc nội dung khóa học gồm chương, bài giảng, tài liệu và bài kiểm tra](images/web/Screenshot%202026-05-15%20002857.png)
...
![Hình 9.11. Giao diện làm bài kiểm tra của học viên](images/web/Screenshot%202026-05-15%20003059.png)
...
![Hình 9.12. Kết quả hoàn thành bài kiểm tra của học viên](images/web/Screenshot%202026-05-15%20003137.png)
...
![Hình 9.13. Chi tiết bài làm và đáp án sau khi hoàn thành bài kiểm tra](images/web/Screenshot%202026-05-15%20003156.png)
...
![Hình 9.14. Danh sách khóa học đã đăng ký của học viên](images/web/Screenshot%202026-05-15%20003314.png)

## 9.5. Nhóm chức năng lớp học của học viên
...
![Hình 9.15. Giao diện tham gia lớp học bằng mã lớp](images/web/Screenshot%202026-05-15%20104438.png)
...
![Hình 9.16. Danh sách lớp học của học viên](images/web/Screenshot%202026-05-15%20112559.png)

## 9.6. Nhóm chức năng hồ sơ người dùng
...
![Hình 9.17. Giao diện hồ sơ cá nhân của người dùng](images/web/Screenshot%202026-05-15%20120426.png)

## 9.7. Nhóm chức năng quản lý của giảng viên
...
![Hình 9.18. Màn hình thống kê tổng quan của giảng viên](images/web/Screenshot%202026-05-15%20120509.png)
...
![Hình 9.19. Giao diện quản lý khóa học của giảng viên](images/web/Screenshot%202026-05-15%20120528.png)
...
![Hình 9.20. Giao diện xây dựng nội dung khóa học](images/web/Screenshot%202026-05-15%20120553.png)
...
![Hình 9.21. Giao diện quản lý bài kiểm tra của giảng viên](images/web/Screenshot%202026-05-15%20120612.png)
...
![Hình 9.22. Giao diện quản lý học viên và tiến độ học tập](images/web/Screenshot%202026-05-15%20120740.png)
...
![Hình 9.23. Giao diện quản lý lớp học của giảng viên](images/web/Screenshot%202026-05-15%20120802.png)
...
![Hình 9.24. Giao diện quản lý khóa học trong một lớp học](images/web/Screenshot%202026-05-15%20120816.png)
